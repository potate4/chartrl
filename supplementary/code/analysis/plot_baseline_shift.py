...
# Training logs are shipped in the supplementary; paths are resolved
# relative to the supplementary root.
_SUPPL = Path(__file__).resolve().parents[2]
NSR_STATE  = _SUPPL / "training_logs" / "nsr_baseline" / "trainer_state.json"
HCPC_STATE = _SUPPL / "training_logs" / "nsr_hcpc"     / "trainer_state.json"
